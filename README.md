...
Settings
Build and Run
Requirements: Android Studio (Giraffe or newer), JDK 17, minSdk 24
Clone: git clone https://github.com/Azuredragon0515/receipt-por-2026
Open the project in Android Studio and wait for Gradle sync
Select the app configuration and run on an emulator or device
Download APK
Go to Actions → the latest green run → Artifacts → app-debug.apk
Settings
API base URL
Check‑in radius
